public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(book1.getBookName() + ", " + book1.author.getAuthorName() + ", " + book1.getPublishingYear());
        System.out.println(book2.getBookName() + ", " + book2.author.getAuthorName() + ", " + book2.getPublishingYear());
